 ...
 * After the lexer, it calls the parser to ensure that the input data respect the syntax specified by a grammar. 
 * If specified in the second argument, it creates a latex file containing the parse tree with the name specified in the third argument.*/
public class Main{
